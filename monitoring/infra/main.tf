...
resource "yandex_vpc_security_group" "sg-otus-devops-microservices-instance-prometheus" {
  description = "Default security group for prometheus instances"
  name        = "sg-${var.project}-${var.environment}-instance-prometheus"
  network_id  = yandex_vpc_network.network-otus-devops-microservices.id
...
module "prometheus-instance" {
  ...
  instance_security_group_ids   = [
    ...
    yandex_vpc_security_group.sg-otus-devops-microservices-instance-prometheus.id,
  ]
  ...
  depends_on = [
    ...
    yandex_vpc_security_group.sg-otus-devops-microservices-instance-prometheus,
  ]
}
